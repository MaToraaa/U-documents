...
const Notification = () => {
  ...
  <PopoverTrigger className='relative flex size-10 items-center justify-center rounded-lg'>
    ...
    <Image src={'/assets/icons/bell.svg'} alt='notification' width={24} height={24}/>
    {count > 0 && (
    ...
    <LiveblocksUIConfig overrides={{ 
        ...
        <InboxNotificationList>
            ...
            {unreadNotifications.length > 0 && unreadNotifications.map((notif) => (
                <InboxNotification key={notif.id} inboxNotification={notif} className='bg-dark-200 text-white' href={`/documents/${notif.roomId}`} showActions={false} kinds={{ 
                    thread: (props) => (
